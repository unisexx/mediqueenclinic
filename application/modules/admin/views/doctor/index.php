...
<section class="content">
    ...
    <div id="btnBox" align="right" style="margin-bottom:10px;">
        <input type="button" title="เพิ่มรายการ" value="เพิ่มรายการ" onclick="document.location='admin/doctors/form'" class="btn btn-primary" />
    </div>

    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title">แพทย์ผู้เชี่ยวชาญ</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
$(function() {
    $(document).on('change', ".switch_status", function () {
        $.ajax({
            ...
            data:{ table : 'doctors', status : $(this).prop('checked'), id : $(this).data('switch-id') },
            dataType: "json",
        });
    });
});
