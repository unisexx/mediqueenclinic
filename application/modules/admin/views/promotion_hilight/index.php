...
<section class="content">
    ...
    <div id="btnBox" align="right" style="margin-bottom:10px;">
        <input type="button" title="เพิ่มรายการ" value="เพิ่มรายการ" onclick="document.location='admin/promotion_hilights/form'" class="btn btn-primary" />
    </div>

    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title">โปรโมชั่นไฮไลท์</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><?if($row->img_th):?><img src="uploads/promotion_hilight/<?=$row->img_th?>" width="200"><?endif;?></td>
                    <td><?if($row->img_en):?><img src="uploads/promotion_hilight/<?=$row->img_en?>" width="200"><?endif;?></td>
                    <td><?php echo $row->url?></td>
                    <td>
                        <a href="admin/promotion_hilights/form/<?=$row->id?>">
                            <button type="button" class="btn btn-secondary btn-sm">แก้ไข</button>
                        </a>
                        <a href="admin/promotion_hilights/delete/<?=$row->id?>">
