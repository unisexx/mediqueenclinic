...
<section class="content">
    ...
    <div id="btnBox" align="right" style="margin-bottom:10px;">
        <input type="button" title="เพิ่มรายการ" value="เพิ่มรายการ" onclick="document.location='admin/review_images/form'" class="btn btn-primary" />
    </div>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="admin/review_images/delete/<?=$row->id?>">
...
$(function() {
    $(document).on('change', ".switch_status", function () {
        $.ajax({
            ...
            data:{ table : 'review_images', status : $(this).prop('checked'), id : $(this).data('switch-id') },
            dataType: "json",
        });
    });
});
