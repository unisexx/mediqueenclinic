...
<section class="content">
    ...
    <form class="form-horizontal" method="post" action="admin/review_categories/save/<?=$rs->id?>" enctype="multipart/form-data" style="padding-bottom:20px;">
    
    <!-- ฟอร์มที่ใช้ร่วมกัน -->
    <div class="card card-info card-outline">
        <div class="card-header">
            <h3 class="card-title">หมวดหมู่รีวิว (เพิ่ม / แก้ไข)</h3>
        </div>
        <div class="card-body">
