 ...
 * @date: 18/3/2015
 */
!function(t){t.kc||(t.kc=new Object),t.kc.fab=function(n,a,i){var o=this;o.$el=t(n),o.el=n,o.$el.data("kc.fab",o);var l,e;o.init=function(){if(("undefined"==typeof a||null===a)&&(a=[{url:null,bgcolor:"red",icon:"+"},{url:"http://www.example.com",bgcolor:"orange",icon:"+"},
{url:"http://www.example.com",bgcolor:"yellow",icon:"+"}]),o.links=a,o.links.length>0){main_btn=o.links[0],color_style=main_btn.color?"color:"+main_btn.color+";":"",bg_color_style=main_btn.bgcolor?"background-color:"+main_btn.bgcolor+";":"",
