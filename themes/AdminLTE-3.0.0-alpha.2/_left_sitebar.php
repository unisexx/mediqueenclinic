...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <nav class="mt-2">
        ...
        <!-- <li class="nav-item has-treeview">
            ...
            <li class="nav-item">
                <a href="themes/AdminLTE-3.0.0-alpha.2/index.html" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
                <p>Dashboard v1</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="themes/AdminLTE-3.0.0-alpha.2/index2.html" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
                <p>Dashboard v2</p>
                </a>
            </li>
            <li class="nav-item">
                <a href="themes/AdminLTE-3.0.0-alpha.2/index3.html" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
                <p>Dashboard v3</p>
                </a>
            </li>
        ...
        <li class="nav-item has-treeview menu-open">
            ...
            <li class="nav-item">
                <a href="themes/AdminLTE-3.0.0-alpha.2/starter.html" class="nav-link">
                <i class="fa fa-circle-o nav-icon"></i>
                <p>Starter Page</p>
                </a>
            </li>
